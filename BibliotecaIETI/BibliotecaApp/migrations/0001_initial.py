# Generated by Django 5.0.4 on 2024-05-03 13:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('no_disponible', models.BooleanField(default=False)),
                ('centro', models.CharField(default='Esteve Terradas Illa', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Centro',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cantidad_disponible', models.IntegerField(default=0)),
                ('centro', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='BibliotecaApp.centro')),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='BibliotecaApp.itemcatalogo')),
            ],
        ),
        migrations.CreateModel(
            name='User',
